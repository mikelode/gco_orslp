...
var methods = {
    ...
    */
    ...
    getColumnNumberFromTitleHeader : function(title){
        var ncols = $(this).find('tbody > tr:first > td').length;
        
        for(var i = 0; i < ncols; i++){
            
            if($(this).jexcel('getHeader',i) == title)
                return i;
        }
        return -1;
    },

    getColumnNameFromTitleHeader : function(title){
        var ncols = $(this).find('tbody > tr:first > td').length;
        
        for(var i = 0; i < ncols; i++){
            
            if($(this).jexcel('getHeader',i) == title)
                return $.fn.jexcel('getColumnName', i);
        }
        return -1;
    },
};
